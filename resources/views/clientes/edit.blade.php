    ...
    <div class="container py-0">
        <div class="card border-primary rounded-0" style="background-color: #62152d;">
            <div class="card-body p-2">
                <h2 class="card-title text-white">Editar Cliente</h2>
                <form id="form-edit-cliente" action="{{url('clientes/'.$cliente->id)}}" method="post">
                    @method("PUT")
                    @csrf 
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="int" class="form-control" name="estatus" id="estatus" value="{{$cliente->estatus}}" required>
                    </div>
